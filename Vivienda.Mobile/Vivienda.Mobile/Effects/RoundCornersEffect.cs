...
namespace Vivienda.Mobile.Effects
{
    public class RoundCornersEffect : RoutingEffect
    {
        protected RoundCornersEffect() : base($"Xamarin.{nameof(RoundCornersEffect)}")
        {
        }

        public static readonly BindableProperty CornerRadiusProperty =
            BindableProperty.CreateAttached("CornerRadius", typeof(int), typeof(RoundCornersEffect), 0, propertyChanged: OnCornerRadiusChanged);
